 ...
 * Generated for Laravel 7.15.0 on 2020-06-13 20:06:27.
 *
...
namespace Cviebrock\LaravelElasticsearch {
    ...
    class Facade {
        ...
        public static function search(array $arr): array {
            return [];
        }

        public static function index(array $arr): array {
             return [];
        }

        public static function indices(): \Elasticsearch\Namespaces\IndicesNamespace{
            new \Elasticsearch\Namespaces\IndicesNamespace();
        }
